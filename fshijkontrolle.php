 ...
 <section id="pjesa2">
    ...
    <?php
        ...
        if(isset($_POST['fshije'])){
            fshijKontrolle($kontrollaid);
        }
    ?>
    <section id="modifikimi">
    <form method="post" id="kontrolla">
            <label>Emri i Pacientit</label>     <label id="mbiemri1" style="margin:22%;">Emri i Mjekut</label><br>
            ...
            <br>
            <label>Emri i Kontrolles</label>    <label id="mbiemri1" style="margin:22%;">Data e Kontrolles</label><br>
            ...
            <textarea id="pershkrimi" name="pershkrimi"style="width: 45%; font-size:20px; background-color: #DFE6EB; text-align:left; margin-left:2.5%;"><?php if(!empty($pershkrimi)) echo $pershkrimi?>
            </textarea>
            <input type="submit" name="fshije" id="fshije" style="margin-left:15%;" value="Fshije">
        </form>
    </section>
